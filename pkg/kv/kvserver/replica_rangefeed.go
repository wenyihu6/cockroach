...
func (r *Replica) registerWithRangefeedRaftMuLocked(
	...
	if p != nil {
		reg, disconnector, filter := p.Register(span, startTS, catchUpIter, withDiff, withFiltering, withOmitRemote,
	...
	// server shutdown.
	reg, disconnector, filter := p.Register(span, startTS, catchUpIter, withDiff,
