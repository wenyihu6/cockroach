...
type Replica struct {
	...
	// proposal and local application of a command on successful writes. An
	// exponentially weighted moving average is used with an effective window size
	// of 30, where recent data points have a higher influence, and older data
	// gradually decays. Thread-safe.
	//
	// Notes:
