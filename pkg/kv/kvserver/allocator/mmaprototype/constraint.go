...
func buildVoterAndAllRelationships(
	...
	return rels, emptyConstraintIndex, emptyVoterConstraintIndex, nil
}

// narrowEmptyConstraint checks whether replicas assigned to an empty
// all-replica constraint can be further narrowed into a non-empty all-replica
// constraint to improve how voter constraints should be susbsumed all-replica
// constraints.
//
