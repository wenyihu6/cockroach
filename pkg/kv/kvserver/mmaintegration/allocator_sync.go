...
type mmaState interface {
	...
	IsInConflictWithMMA(cand roachpb.StoreID, cands []roachpb.StoreID, cpuOnly bool) bool
}
...
func (as *AllocatorSync) IsInConflictWithMMA(
	cand roachpb.StoreID, cands storepool.StoreList, cpuOnly bool,
) bool {
	...
	return as.mmaAllocator.IsInConflictWithMMA(cand, storeIDs, cpuOnly)
}
