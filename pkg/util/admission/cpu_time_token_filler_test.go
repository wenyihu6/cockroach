...
func (m *testBurstManager) refillBurstBucketForGroup(
	_ uint64, toAdd int64, _ int64, _ int64, _ bool,
) {
	...
	allocator := &cpuTimeTokenAllocator{
		...
		strategy: &rmStrategy{
			...
			groups: map[uint64]rmGroupConfig{
				highResourceGroupID: {burstFrac: 1.0, maxCPU: true},
				lowResourceGroupID:  {burstFrac: 0.25, maxCPU: false},
			},
		},
	}
