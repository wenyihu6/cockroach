...
// admission.cpu_time_tokens.enabled is true, it returns a WorkQueue
// that implements CPU time token AC. There is one WorkQueue for system
// tenant work and another for app tenant work.
