...
func TestCPUTimeTokenGranter(t *testing.T) {
	...
	datadriven.RunTest(t, datapathutils.TestDataPath(t, "cpu_time_token_granter"), func(t *testing.T, d *datadriven.TestData) string {
		...
		case "init":
			...
			if d.HasArg("canburst") {
				var n int64
				d.ScanArgs(t, "canburst", &n)
		...
		case "refill":
			// Delta, bucket capacity, & bucket minimums for 2-bucket design.
		...
		// continueGrantChain is a NOP for cpuTimeTokenGranter. Still,
